...
function signUrl($myUrlToSign, $privateKey)
{
 ...
 $signedUrl =  signUrl("http://maps.google.com/maps/api/staticmap?center=Z%C3%BCrich&zoom=12&size=400x400&key=AIzaSyDFjtg9sHbwu92g4-_shTmqI84gSChJzO0", '8LsYJwsSvKDzzBEDTLpExmKlT8w=');
